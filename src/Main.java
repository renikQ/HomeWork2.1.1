...
public class Main {
    public static void main(String[] args) {
        Car ladaGranta = new Car("Lada", "Granta", 1.7,
                ...
                "седан", "А196АА132", 5, false,
                new Car.Key(false, false),
                new Car.Insurance(LocalDate.now().plusMonths(3), 100f, "123456589"));
